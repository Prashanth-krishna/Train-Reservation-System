...
$query = mysql_query("select fare from train where id='$train'");
if($query>0)
{
...
function e()
{
	...
	{
		<?php
		//header("Location:booked.php?id=$uid&train=$train&seat=$seat");
		?>
		window.location ="booked.php?id=<?php echo $uid;?>&train=<?php echo $train?>&seat=<?php echo $seat;?>&c=<?php echo $c;?>";
	}
	else
	{
	}

...
if(isset($_POST['book']))
{
	...
	header("Location:pay.php?id=$uid&train=$train&seat=$seat&c=$choice");
	}
	else
	{
		?>
...
?>
<form name="frm" method="post" action="<?php echo $_SERVER['PHP_SELF'];?>?id=<?php echo $uid;?>&train=<?php echo $train;?>">
No. of Seats:
